  ...
  return (
    <div>
      ...
      <div className="fairyNft">
        ...
        <center>
          <h2 className="cool ">With the <span className="green"> cool</span>- <span className="yellow"> vibe </span> fairy style themed characters,
            We could well <span className="yellow"> deGen </span> more than 1,000,000+ of them.

            But we just want to allow <span className="green"> 5,555 </span> to be out there.</h2>
